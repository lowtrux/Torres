...
var map = {
	...
	"./hide-submenu.png": 23,
	"./home.png": 24,
	"./icon-breadCrumb.png": 25,
	"./icon-facebook.png": 26,
	"./icon-facebookBlack.png": 27,
	"./icon-folder.svg": 28,
	"./icon-instagram.png": 29,
	"./icon-instagramBlack.png": 30,
	"./icon-instagramGreen.png": 31,
	"./icon-lkdn.png": 32,
	"./icon-main-search-desktop.png": 33,
	"./icon-pinterest.png": 34,
	"./icon-twitter.png": 35,
	"./icon-youtube.png": 36,
	"./jlWhite.png": 37,
	"./language-flag.png": 38,
	"./logo-corp-footer.png": 39,
	"./logo-corp-header.png": 40,
	"./logo-corp-login.png": 41,
	"./logoFamiliaTorres.png": 42,
	"./logoJL.png": 43,
	"./logoProduct.png": 44,
	"./logoTorres.png": 45,
	"./magdala.png": 46,
	...
	"./marimarState.png": 54,
	"./marimarWhite.png": 55,
	"./masterDistillers.png": 56,
	"./menuWines.png": 57,
	"./otherBrands.png": 58,
	"./product-2.png": 59,
	"./product.png": 60,
	"./propertiesWhite.png": 61,
	"./rocado.png": 62,
	"./rocado1.jpg": 63,
	"./rocado2.jpg": 64,
	"./rocado3.jpg": 65,
	"./rocadoHome.jpg": 66,
	"./rocadoSpirits.png": 67,
	"./sangreToroHome1.png": 68,
	"./sangreToroHome2.png": 69,
	"./sangreToroHome3.png": 70,
	"./sangreToroLogo.png": 71,
	"./search.png": 72,
	"./show-submenu.png": 73,
	"./spiritsIcon.png": 74,
	"./torresBrandy.png": 75,
